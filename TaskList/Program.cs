...
namespace TaskList
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                new TaskItem("Mytao", "Clean office", DateTime.Parse("10/24/2020 3:00 pm")),
                new TaskItem("Akii", "Fix desk", DateTime.Parse("10/25/2020 5:00 pm"))
            };
            while (menuChoice != 5)
            {
        ...
        static string DisplayMenu()
        {
            ...
            Console.WriteLine("GC Task List" + Environment.NewLine);
